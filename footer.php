<footer class="footer">
    <div class="container">
        ...
        <div class="footer-bottom">
            <p>&copy; 2026 S&N GuardianGrid Technologies. All rights reservedgit .</p>

            <div class="footer-links">
                <a href="privacy.php">Privacy Policy</a>
                <a href="terms.php">Terms of Service</a>
            </div>
            <div class="footer-credit"> Design &amp; developed with <span class="heart" aria-hidden="true">♥</span> by
                <a href="https://joban-portfolio.netlify.app/" class="footer-credit-link" target="_blank"
                    rel="noopener noreferrer">Joban</a></div>
        </div>
    </div>
</footer>
...
<a href="https://wa.me/+918427590032 for whatsap" class="footer-whatsapp" aria-label="Chat on WhatsApp" target="_blank"
